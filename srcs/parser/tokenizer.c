...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/10/06 15:25:00 by dbanzizi          #+#    #+#             */
/*   Updated: 2021/10/06 15:25:01 by dbanzizi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_token	*switch_token(t_tokenizer *t, char *temp)
{
	if (temp[0] == PIPE)
		...
		return (quote_token(t, DOUBLE_QUOTE, SINGLE_QUOTE));
	else if (temp[0] == SINGLE_QUOTE)
		return (quote_token(t, SINGLE_QUOTE, DOUBLE_QUOTE));
	else if (!temp[0])
